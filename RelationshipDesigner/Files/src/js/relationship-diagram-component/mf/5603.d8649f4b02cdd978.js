...
`]}]}],null,{hsl:[{type:e.Input}],rgb:[{type:e.Input}],hex:[{type:e.Input}],disableAlpha:[{type:e.Input}],onChange:[{type:e.Output}]})}();class c{constructor(){this.onClick=new e.EventEmitter,this.onSwatchHover=new e.EventEmitter,this.swatchStyle={borderRadius:"3px",boxShadow:"inset 0 0 0 1px rgba(0,0,0,.15)"}}handleClick({hex:n,$event:t}){this.onClick.emit({hex:n,$event:t})}normalizeValue(n){return typeof n=="string"?{color:n}:n}focusStyle(n){return{boxShadow:`inset 0 0 0 1px rgba(0,0,0,.15), 0 0 4px ${this.normalizeValue(n).color}`}}}c.\u0275fac=function(n){return new(n||c)},c.\u0275cmp=e.\u0275\u0275defineComponent({type:c,selectors:[["color-sketch-preset-colors"]],inputs:{colors:"colors"},outputs:{onClick:"onClick",onSwatchHover:"onSwatchHover"},decls:2,vars:1,consts:[[1,"sketch-swatches"],["class","sketch-wrap",4,"ngFor","ngForOf"],[1,"sketch-wrap"],[1,"swatch",3,"color","focusStyle","onClick","onHover"]],template:function(n,t){n&1&&(e.\u0275\u0275elementStart(0,"div",0),e.\u0275\u0275template(1,k,2,4,"div",1),e.\u0275\u0275elementEnd()),n&2&&(e.\u0275\u0275advance(1),e.\u0275\u0275property("ngForOf",t.colors))},dependencies:[g.NgForOf,a.SwatchComponent],styles:[".sketch-swatches[_ngcontent-%COMP%]{position:relative;display:flex;flex-wrap:wrap;margin:0 -10px;padding:10px 0 0 10px;border-top:1px solid rgb(238,238,238)}.sketch-wrap[_ngcontent-%COMP%]{width:16px;height:16px;margin:0 10px 10px 0}[dir=rtl][_nghost-%COMP%]   .sketch-swatches[_ngcontent-%COMP%], [dir=rtl]   [_nghost-%COMP%]   .sketch-swatches[_ngcontent-%COMP%]{padding-right:10px;padding-left:0}[dir=rtl][_nghost-%COMP%]   .sketch-wrap[_ngcontent-%COMP%], [dir=rtl]   [_nghost-%COMP%]   .sketch-wrap[_ngcontent-%COMP%]{margin-left:10px;margin-right:0}"],changeDetection:0}),function(){(typeof ngDevMode>"u"||ngDevMode)&&e.\u0275setClassMetadata(c,[{type:e.Component,args:[{selector:"color-sketch-preset-colors",template:`
